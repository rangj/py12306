...
class Config:
    ...
    # 打码平台账号
    AUTO_CODE_PLATFORM = ''
    AUTO_CODE_ACCOUNT = {'user': '851594961@qq.com', 'pwd': 'zhaoyin93911'}
    # 输出日志到文件
    ...
    NOTIFICATION_VOICE_CODE_PHONE = 13273775593
    NOTIFICATION_API_APP_CODE = '9b39e6f7b91d41aa887462447d032400'
